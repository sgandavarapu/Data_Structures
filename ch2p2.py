...
#To write a winning strategy for one of these games, we can’t just fixed list a sequence of moves. 
...
#Let’s call a state of the game hot if the current player to move has a winning strategy to finish the game 
#-this is the state that you want to be in. Otherwise, let’s call it cold. 
...
#
#For this problem, let’s consider a two-player version of the decreasing number game. 
